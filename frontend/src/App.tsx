...
import { EnvironmentStudio, LocationMap } from "./EnvironmentStudio";
    ...
    >
      ...
      {project && (
        <><MusicPlayer
            ...
            revision={revision}
            fail={setError}
          /><AmbientPlayer projectId={project.id} revision={revision} onScene={setSceneEnvironment} /></>
      )}
