...
export type RequirementExpression = {
  kind?: "and" | "or" | "not" | "compare" | "has_item" | "has_tag" | "relationship" | "location" | "time" | "weather" | "has_ability";
  children?: RequirementExpression[];
  child?: RequirementExpression | null;
  target?: "actor" | "target" | "party" | "location" | "nearby_enemies" | "faction_members" | "relationship_target" | "allies" | "enemies" | "all" | "random";
...
export type AbilityAction = {
  kind: "apply_effect" | "move" | "create" | "remove" | "reveal_knowledge" | "change_relationship" | "advance_time" | "play_noise";
  target: string;
