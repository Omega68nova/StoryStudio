...
export type RuleSelectorKind = "actor" | "source" | "target" | "current_location" | "ability" | "effect" | "explicit" | "relationship_target";
export type RuleObjectSelector = { kind: RuleSelectorKind; object_id?: string | null; object_kind?: RuleOwnerKind | null };
export type ValueExpression =
  | { kind: "constant"; value: number }
  | { kind: "stat"; selector: RuleObjectSelector; stat_key: string }
