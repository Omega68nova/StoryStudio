  ...
  return (
    <div className="world-configuration">
      ...
      <div className="world-configuration-content">
        ...
        {section === "locations" && <LocationMapStudio projectId={projectId} revision={revision} workflows={workflows} fail={fail} openEnvironmentLocation={openEnvironmentLocation} />}
